...
// `clops` tmux session, and on a fresh startup recreate them as *lazy*
 ...
 * `clops launch` (recordLaunchedSession wrote its tab) may not have flushed its
 ...
 *
 * The `clops launch` CLI runs as its own process and never goes through the
