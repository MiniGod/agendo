...
//
// Its own module beside src/orchestration/index.ts for the same reason
// src/launch/prompt.ts sits beside src/launch/index.ts: this is ~140 lines of prose and
