import { freshName, prFreshName } from "../../launch/index.ts";
import { defaultBranch } from "../../repositories/worktree/index.ts";
import { ORCHESTRATOR_SLUG } from "../../orchestration/index.ts";
import { V } from "./vocabState.ts";
import type { LinkedPR, PRWithSessions, WorkItem } from "../../shared/types.ts";
