...
import { itemKey, liveKey, prKey, type LoadedModel } from "../model.ts";
...
import { useProfileMove } from "./profileMove.ts";
...
export default function App({
  ...
  const { enterProfilePicker, moveToProfile } = useProfileMove({
    model, modelRef, setMode, setNotice, setBusy, setActivity, requested, reload, hostSession,
  });
