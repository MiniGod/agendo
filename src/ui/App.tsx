 ...
 * launcher, bare `clops`). `hostSession` is the tmux host session the menu runs
...
export default function App({
  ...
  // `clops` has no root, so it's always effectively global.
  ...
  useInput((input, key) => {
    ...
    // bare `clops` is already global, so there's nothing to toggle). `a` = "all".
