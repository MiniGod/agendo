...
import { loadModel, loadLocalSessions, isRunning, itemKey, prKey, filterModelByRepos, type LoadedModel } from "../model.ts";
...
import { discoverGitReposUnder, mergeRepos, repoRootForCwd, type RepoInfo } from "../repos.ts";
...
export default function App({
  ...
  useEffect(() => {
    ...
    setModel(null);
    let cancelled = false;
    loadModel({ provider, identity, hostSession, scopeRepos: discoveredRepos })
