...
// it had before.
export { loadRestore, type RestoreTab } from "./store.ts";
export { placeholderArgv, restoreTabs } from "./placeholder.ts";
 ...
 * it calls per window reads the orchestrator marker file (see src/orchestration/index.ts)
