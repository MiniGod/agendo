...
// it exported before.
export { parseRepoUrl, redactUrl, repoUrlLabel } from "./url.ts";
export type { RepoHost, RepoUrl } from "./url.ts";
export { cloneDirName, enclosingCheckout, findMatchingCheckout, freeCloneDest } from "./checkout.ts";
export { startClone } from "./run.ts";
export type { CloneFailure, CloneOutcome, CloneRun } from "./run.ts";
