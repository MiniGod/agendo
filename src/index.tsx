...
Usage:
  clops                       Open the launcher in its own tmux session (default)
  ...
  clops list, ls              List the sessions running right now, one per line
...
// By default clops runs inside a single canonical tmux session (named `clops`):
