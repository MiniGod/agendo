...
//
// The shape lives here rather than in src/repositories/gitRefs.ts, which produces it,
...
/**
 * How a BranchSync is obtained. `src/repositories/gitRefs.ts` provides the only real
