import { openUrlAsync } from "../../runtime/browser.ts";
import { SELF_CMD } from "../../launch/index.ts";
import { linkLine, linkVocab, printLine } from "../output.ts";
import { type SessionScope, scopeFilter, scopeNote } from "../../app/scope.ts";
import { SessionIndex } from "../../sessions/index.ts";
import { shortId } from "../../runtime/tmux/index.ts";
import { resolveSessionLink, usableLinks } from "../links.ts";
import type { SessionLink } from "../../app/model/index.ts";
